...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form action="{{ route('class-edit', ['id' => $class->id]) }} " enctype="multipart/form-data"
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select class="form-control" name="teacher_id">
						...
						@php
						$selected = '';
						if($item->id == $class->teacher_id) // Any Id
						{
			...
			@php
			$imageFileName = $class->image ?? null;
			@endphp
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">
					Main Image
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input class="form-control" max="3000-12-31" min="1000-01-01" name="start_date" required=""
						type="date" value="{{ $class->start_date }}" />
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">
				...
				<div class="col-sm-5">
					<input class="form-control" max="3000-12-31" min="1000-01-01" name="end_date" required=""
						type="date" value="{{ $class->end_date }}" />
				</div>
			</div>
			<div class="add-btn">
