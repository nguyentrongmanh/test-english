...
@section('content')
	<div class="card shadow mb-4">
        ...
        <div class="card-body">
        	<form method="POST" id="add-listening-form" enctype='multipart/form-data' action="{{ route('create-listening') }}">
        		@csrf
				...
				<div class="question-list">
					<div class="question-item">
						<div class="form-group">
						    ...
						    <input name="questions[0][question]" class="form-control" id="exampleFormControlTextarea1" type="text"></input>
						</div>
						<div class="form-group">
						    <label for="exampleFormControlTextarea1">Option A</label>
						    <input class="form-control" name="questions[0][option_a]" id="exampleFormControlTextarea1" type="text"></input>
						</div>
						<div class="form-group">
						    <label for="exampleFormControlTextarea1">Option B</label>
						    <input class="form-control" name="questions[0][option_b]" id="exampleFormControlTextarea1" type="text"></input>
						</div>
						<div class="form-group">
						    <label for="exampleFormControlTextarea1">Option C</label>
						    <input class="form-control" name="questions[0][option_c]" id="exampleFormControlTextarea1" type="text"></input>
						</div>
						<div class="form-group">
						    <label for="exampleFormControlTextarea1">Option D</label>
						    <input class="form-control" name="questions[0][option_d]" id="exampleFormControlTextarea1" type="text"></input>
						</div>
						<div class="form-group">
							<div>Aswer</div>
							<div class="form-check form-check-inline">
							    <input class="form-check-input" type="radio" name="questions[0][answer]" id="inlineRadio1" value="A">
							    <label class="form-check-label" for="inlineRadio1">A</label>
							</div>
							<div class="form-check form-check-inline">
							    <input class="form-check-input" type="radio" name="questions[0][answer]" id="inlineRadio2" value="B">
							    <label class="form-check-label" for="inlineRadio2">B</label>
							</div>
							<div class="form-check form-check-inline">
							    <input class="form-check-input" type="radio" name="questions[0][answer]" id="inlineRadio3" value="C">
							    <label class="form-check-label" for="inlineRadio3">C</label>
							</div>
							<div class="form-check form-check-inline">
							    <input class="form-check-input" type="radio" name="questions[0][answer]" id="inlineRadio3" value="D">
							    <label class="form-check-label" for="inlineRadio3">D</label>
							</div>
						</div>
						<div class="form-group">
						    <label for="exampleFormControlTextarea1">Explain</label>
						    <textarea class="form-control" id="exampleFormControlTextarea1" name="questions[0][explain]" rows="3"></textarea>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#add-listening-form").on("submit", function(e) {
				$("input[name=post]").val(quill.container.innerHTML);
				$(this).submit();
			});
